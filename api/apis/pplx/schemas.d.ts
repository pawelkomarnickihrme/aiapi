    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly return_citations: {
                ...
                readonly description: "Determines whether or not a request to an online model should return citations. Citations are in closed beta access. To request access, apply at https://perplexity.typeform.com/apiaccessform?typeform-source=docs.perplexity.ai";
            };
            readonly search_domain_filter: {
                readonly title: "Search Domain Filter";
                readonly type: "array";
                readonly default: any;
                readonly description: "Given a list of domains, limit the citations used by the online model to URLs from the specified domains. This feature is in closed beta access. To request access, apply at https://perplexity.typeform.com/apiaccessform?typeform-source=docs.perplexity.ai";
                readonly items: {};
            };
            readonly return_images: {
                ...
                readonly type: "boolean";
                readonly default: false;
                readonly description: "Determines whether or not a request to an online model should return images. Images are in closed beta access. To request access, apply at https://perplexity.typeform.com/apiaccessform?typeform-source=docs.perplexity.ai";
            };
            readonly return_related_questions: {
                readonly title: "Return Related Questions";
                readonly type: "boolean";
                readonly default: false;
                readonly description: "Determines whether or not a request to an online model should return related questions. Related questions are in closed beta access. To request access, apply at https://perplexity.typeform.com/apiaccessform?typeform-source=docs.perplexity.ai";
            };
            readonly top_k: {
